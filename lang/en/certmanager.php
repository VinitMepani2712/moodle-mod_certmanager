...
$string['certificateincomplete'] = 'Certificate record is incomplete.';
$string['certificatenotfound'] = 'Certificate not found or code is invalid.';
$string['certificatetitle'] = 'Certificate title';
$string['certificateverified'] = 'Certificate <strong>{$a}</strong> has been verified.';
...
$string['deleteelement'] = 'Delete this element?';
...
$string['messageprovider:awarded'] = 'User certified';
$string['messageprovider:expired'] = 'Certification expired';
$string['messageprovider:lapsed'] = 'Certification lapsed';
$string['messageprovider:reminder'] = 'Certification expiration reminder';
$string['messageprovider:windowopen'] = 'Recertification window opened';
...
$string['nocertifications'] = 'You have no certifications yet.';
$string['noelementsyet'] = 'No elements yet. Add some using the toolbar above.';
...
$string['privacy:metadata:actorid'] = 'The ID of the user who made the status change';
$string['privacy:metadata:certificates'] = 'Generated certificate files in PDF format';
$string['privacy:metadata:certmanager_certificates'] = 'Records of certificates issued to users';
$string['privacy:metadata:certmanager_history'] = 'Audit trail of all certification state changes';
$string['privacy:metadata:certmanager_state'] = 'Current certification state for each user';
$string['privacy:metadata:code'] = 'Plaintext verification code displayed on the certificate';
$string['privacy:metadata:codehash'] = 'SHA256 hash of the verification code for secure lookup';
$string['privacy:metadata:fromstatus'] = 'The certification status before the change';
...
$string['privacy:metadata:progresspct'] = 'User progress toward certification as a percentage';
...
$string['privacy:metadata:timelapsed'] = 'When the certification lapsed or expired';
...
$string['privacy:metadata:timewindowopens'] = 'When the recertification window opens';
$string['privacy:metadata:tostatus'] = 'The certification status after the change';
$string['privacy:metadata:userid'] = 'The ID of the user';
$string['privacy:metadata:usermodified'] = 'The ID of the user who last modified the record';
$string['privacy:path:certificates'] = 'Certificate records and files';
$string['privacy:path:history'] = 'Certification history';
$string['privacy:path:state'] = 'Certification state';
...
$string['rulecohort'] = 'Cohort membership';
$string['ruleprofilefield'] = 'User profile field';
...
$string['verifycodeinfo'] = 'Enter or scan a verification code.';
$string['verificationcode'] = 'Verification code';
$string['verifyagain'] = 'Please verify the code and try again.';
