...
/**
 * Certificate element: coursename.
 *
 * @package    mod_certmanager
 * @copyright  2026 Vinit Mepani
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class coursename extends base {
    /**
    ...
    public function render_pdf(
        ...
        $pdf->MultiCell($w, $lineh, $name, 0, $this->get_alignment(), false, 1, '', '', true, 0, false, true, 0);
    }
    ...
    public function render_html(\stdClass $certmanager, \stdClass $course): string {
        return '<strong>' . s(format_string($course->fullname)) . '</strong>';
    }
}
