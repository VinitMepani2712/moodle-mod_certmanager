...
/**
 * Event fired when a user's certification passes its expiry date.
 *
...
class certification_expired extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcertificationexpired', 'mod_certmanager');
    }
    ...
    public function get_description() {
        return "The certification with id '{$this->other['certid']}' changed state " .
            "(a user's certification passes its expiry date) for the user with id '$this->relateduserid'.";
    }
