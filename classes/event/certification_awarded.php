...
/**
 * Event fired when a user is awarded or renews a certification.
 *
 * @package    mod_certmanager
 * @copyright  2026 Vinit Mepani
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class certification_awarded extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventcertificationawarded', 'mod_certmanager');
    }
    ...
    public function get_description() {
        return "The certification with id '{$this->other['certid']}' changed state " .
            "(a user is awarded or renews a certification) for the user with id '$this->relateduserid'.";
    }
