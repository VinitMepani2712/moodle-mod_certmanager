...
/**
 * Event fired when a user's recertification window opens.
 *
 * @package    mod_certmanager
 * @copyright  2026 Vinit Mepani
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class recert_window_opened extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventrecertwindowopened', 'mod_certmanager');
    }
    ...
    public function get_description() {
        return "The certification with id '{$this->other['certid']}' changed state " .
            "(a user's recertification window opens) for the user with id '$this->relateduserid'.";
    }
